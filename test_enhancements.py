...
class SystemTester:
    ...
    def test_csv_data_integrity(self):
        ...
        try:
            ...
            required_cols = ['NDVI', 'SAVI', 'Temperature', 'Soil_pH', 'Crop_Health_Label']
        ...
        try:
            ...
            required_cols = ['District_Name', 'Crop', 'Fertilizer', 'Nitrogen', 'Phosphorus']
        ...
        try:
            ...
            if load_success:
                ...
                if 'enhanced_agriculture' in processor.datasets:
                    ...
                    has_health_score = 'comprehensive_health_score' in enhanced_df.columns
                    has_soil_index = 'soil_quality_index' in enhanced_df.columns
                    self.log_test("Enhanced crop features", has_health_score and has_soil_index)
    ...
    def test_database_creation(self):
        ...
        try:
            ...
            if (processor.load_all_datasets() and 
                processor.create_integrated_features() and 
    ...
    def test_chatbot_setup(self):
        ...
        try:
            ...
            if has_model_attr:
                ...
                self.log_test("Chatbot model object valid", mcs.model is None or hasattr(mcs.model, 'generate_content'))
        except Exception as e:
    ...
    def test_file_structure(self):
        ...
        try:
            ...
            has_derived_features = (
                'comprehensive_health_score' in features and
                'soil_quality_index' in features and
                'environmental_stress' in features
            )
            ...
            has_prediction = (
                'health_score' in prediction and
                'health_status' in prediction and
    ...
    def test_system_integration(self):
        ...
        try:
            ...
            if datasets_loaded:
                ...
                self.log_test("Integration: Data loading + Feature creation", features_created)
                
                # Test data consistency
                if 'enhanced_agriculture' in processor.datasets:
                    df = processor.datasets['enhanced_agriculture']
                    has_consistent_data = (
                        df['comprehensive_health_score'].notna().all() and
                        df['soil_quality_index'].notna().all()
                    )
    ...
    def run_performance_test(self):
        ...
        try:
            ...
            self.log_test("Performance: Dataset loading", performance_acceptable, 
            ...
            if load_success:
                ...
                feature_performance = feature_time < 10  # Should complete within 10 seconds
                self.log_test("Performance: Feature creation", feature_performance,
    ...
    def generate_test_report(self):
        ...
        return self.passed_tests / self.total_tests > 0.8  # 80% pass rate considered successful
    ...
    def run_all_tests(self):
        ...
        if success:
            ...
            print("Your Maharashtra Agricultural System has been significantly enhanced!")
        else:
